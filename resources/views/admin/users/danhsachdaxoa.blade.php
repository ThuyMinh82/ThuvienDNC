...
@section('header')
<title>Danh sách tài khoản đã xóa</title>
@endsection
...
<div class="row no-gutters">
    ...
    <div class="col-md-8 col-sm-12 padding-0">
        <table style="width: 100%">
          <tbody>
              <tr>
                <th ><h3 style="text-align: center;">Danh sách tài khoản đã xóa</h3></th>
                <th style="width: 250px;">
                  <form action="admin/users/danhsachdaxoa/search" method="GET">
            ...
            <tbody>
                ...
                <div class="modal fade" id="myModal{{$us->id}}">
                    ...
                    <div class="modal-content">
                        ...
                        Bạn có thật sự muốn phục hồi khoản này?
                        </div>
                        <!-- Modal footer -->
