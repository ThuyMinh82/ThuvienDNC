...
INSERT INTO `chudebv` (`id_cd`, `ten_cd`, `alias`) VALUES
(1, 'Góc tản mạn sinh viên', 'goc-tan-man-sinh-vien'),
(2, 'Tin tức & sự kiện', 'tin-tuc-&-su-kien'),
(3, 'Giới thiệu sách', 'gioi-thieu-sach'),
(4, 'Sách tặng', 'sach-tang');
...
INSERT INTO `hinhanh` (`id_anh`, `link_anh`, `id_bv`) VALUES
(1, '1530586831.jpg', NULL),
(2, '1530587083.png', 1),
(3, '1530587132.png', 1),
(4, '1530587431.jpg', 2),
(5, '1530587421.jpg', 3),
(6, '15305874312.jpg', 5),
(7, '1530582217431.jpg', 6),
(8, '1531230587431.jpg', 4),
(9, '1530587435641.jpg', 6);
...
INSERT INTO `phanquyen` (`id_pq`, `ten_pq`, `id_group`) VALUES
(1, 'Quyền Admin', 1),
(2, 'Quyền User', 2);
...
INSERT INTO `usergroup` (`id_group`, `name_group`) VALUES
(1, 'admin'),
(2, 'user');
...
INSERT INTO `users` (`id_user`, `username`, `password`, `status`, `id_group`) VALUES
(1, 'admin1', 'e00cf25ad42683b3df678c61f42c6bda', 1, 1),
(2, 'admin2', 'c84258e9c39059a89ab77d846ddab909', 1, 1),
(3, 'admin3', '32cacb2f994f6b42183a1300d9a3e8d6', 1, 1),
(4, 'user1', '24c9e15e52afc47c225b757e7bee1f9d', 1, 2),
(5, 'user2', '7e58d63b60197ceb55a1c487989a3720', 1, 2),
(6, 'user3', '92877af70a45fd6a2ed7fe81e1236b78', 1, 2);
