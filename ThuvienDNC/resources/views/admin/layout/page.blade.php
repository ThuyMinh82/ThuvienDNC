...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="./backend/jquery-1.11.3.min.js"></script>
    ...
    <div class="container-fluid">
        <div class="row no-gutters" id="banner">
            ...
            <div class="col-xl-6 col-lg-7 col-md-8 col-sm-12" id ="color">
                <a href="index.blade.php"  class="logo"><img src="images/logo.png" id="logo"></a>
            </div>
            <div class="col-xl-4 col-lg-5 col-md-4" id = "color">
                <img src="images/block-banner.png" id="logo1">
            </div>
            <div class="col-xl-1"></div>
        </div>
                    ...
                    <div class="collapse navbar-collapse" id="collapsibleNavbar">
                        <ul class="navbar-nav">
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="user_grant.blade.php">Cấp Quyền</a>
                                    <a class="dropdown-item" href="user_drop.blade.php">Xóa Tài Khoản</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="bv_change.blade.php">Sửa Bài Viết</a>
                                    <a class="dropdown-item" href="bv_drop.blade.php">Xóa Bài Viết</a>
                                    <a class="dropdown-item" href="bv_alow.blade.php">Duyệt Bài Viết</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="image_show.blade.php">Đưa Ảnh Lên Slide</a>
                                    <a class="dropdown-item" href="image_drop.blade.php">Xóa Ảnh</a>
                                </div>
                            </li>
                        </ul>
                        <ul class="nav navbar-nav ml-auto">
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="pw_change.blade.php">Đổi mật khẩu</a>
